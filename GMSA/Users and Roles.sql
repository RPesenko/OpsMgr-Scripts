...
ALTER ROLE ConfigService ADD MEMBER [CONTOSO\OMMSAA_GMSA$]
ALTER ROLE db_accessadmin ADD MEMBER [CONTOSO\OMMSAA_GMSA$]
...
ALTER ROLE db_securityadmin ADD MEMBER [CONTOSO\OMMSAA_GMSA$]
ALTER ROLE dbmodule_users ADD MEMBER [CONTOSO\OMMSAA_GMSA$]
ALTER ROLE sdk_users ADD MEMBER [CONTOSO\OMMSAA_GMSA$]
ALTER ROLE sql_dependency_subscriber ADD MEMBER [CONTOSO\OMMSAA_GMSA$]
...
*/
CREATE LOGIN [CONTOSO\OMMSAA_SA$] FROM WINDOWS;
CREATE LOGIN [CONTOSO\OMSDK_GMSA$] FROM WINDOWS;
CREATE LOGIN [CONTOSO\OMDW_GMSA$] FROM WINDOWS;
...
CREATE USER [CONTOSO\OMMSAA_SA$]
CREATE USER [CONTOSO\OMSDK_GMSA$]
CREATE USER [CONTOSO\OMDW_GMSA$]
CREATE USER [CONTOSO\OMRep_GMSA$]

ALTER ROLE apm_datareader ADD MEMBER [CONTOSO\OMMSAA_SA$]
ALTER ROLE db_datareader ADD MEMBER [CONTOSO\OMMSAA_SA$]
ALTER ROLE OpsMgrReader ADD MEMBER [CONTOSO\OMMSAA_SA$]
...
-- Replace 'CONTOSO_MG' with the name of the management group
--
UPDATE OperationsManagerDW.[dbo].[ManagementGroup] SET [WriterLoginName] = 'CONTOSO\OMDW_SA$' WHERE [ManagementGroupDefaultName] = 'CONTOSO_MG'
/*--------------------------------------------------------*/
/*--------------------------------------------------------*/
