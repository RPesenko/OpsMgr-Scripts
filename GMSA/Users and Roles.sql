...
ALTER ROLE apm_datareader ADD MEMBER [CONTOSO\OMMSAA_GMSA$]
ALTER ROLE db_datareader ADD MEMBER [CONTOSO\OMMSAA_GMSA$]
ALTER ROLE OpsMgrReader ADD MEMBER [CONTOSO\OMMSAA_GMSA$]
...
--
UPDATE OperationsManagerDW.[dbo].[ManagementGroup] SET [WriterLoginName] = 'CONTOSO\OMDW_GMSA$' WHERE [ManagementGroupDefaultName] = 'CONTOSO_MG'
/*--------------------------------------------------------*/
/*--------------------------------------------------------*/
